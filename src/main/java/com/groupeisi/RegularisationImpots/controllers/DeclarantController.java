package com.groupeisi.RegularisationImpots.controllers	;
...
public class DeclarantController {
    ...
    public String showAddDeclarantForm(Model model) {
        ...
        return "formulairedeclarant"; // Correspond au nom du template Thymeleaf
    }
    @PostMapping("/add")
    ...
    public String showDeclarants(Model model) {
        ...
        return "listedeclarant"; // Correspond au nom du template Thymeleaf
    }
}
