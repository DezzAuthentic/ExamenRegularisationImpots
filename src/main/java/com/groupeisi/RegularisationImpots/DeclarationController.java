...
import com.groupeisi.RegularisationImpots.services.DeclarantService;
import com.groupeisi.RegularisationImpots.services.DeclarationService;
...
public class DeclarationController {
    ...
    public String showAddDeclarationForm(Model model) {
        ...
        return "formulairedeclaration"; // Correspond au nom du template Thymeleaf
    }
    ...
    public String showDeclarations(Model model) {
        ...
        return "listedeclaration"; // Correspond au nom du template Thymeleaf
    }
}
